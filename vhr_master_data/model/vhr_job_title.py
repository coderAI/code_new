...
class vhr_job_title(osv.osv):
    _name = 'vhr.job.title'
    _description = 'VHR Job Title'
    _order = 'name asc'
...
#                 'job_level_id': fields.many2one('vhr.job.level', 'Job Level', ondelete='restrict'),
    ...
    _unique_insensitive_constraints = [{'code': "Job Title's Code is already exist!"},
                                       {'name': "Job Title's Vietnamese Name is already exist!"}]
    ...
    def name_search(self, cr, uid, name, args=None, operator='ilike', context=None, limit=100):
        ...
        return super(vhr_job_title, self).name_search(cr, uid, name, args, operator, context, limit)
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        res = False
        try:
            res = super(vhr_job_title, self).unlink(cr, uid, ids, context)
