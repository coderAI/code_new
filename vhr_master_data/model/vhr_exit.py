...
class vhr_exit(osv.osv):
    _name = 'vhr.exit'
    _description = 'VHR Exit'
    ...
    _unique_insensitive_constraints = [{'code': "Exit's Code is already exist!"},
                                       {'name': "Exit's Vietnamese Name is already exist!"}]
    ...
    def name_search(self, cr, uid, name, args=None, operator='ilike', context=None, limit=100):
        ...
        return super(vhr_exit, self).name_search(cr, uid, name, args, operator, context, limit)
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        res = False
        try:
            res = super(vhr_exit, self).unlink(cr, uid, ids, context)
